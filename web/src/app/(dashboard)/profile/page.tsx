        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-black rounded-3xl border border-gray-100 dark:border-zinc-900 p-8 shadow-sm">
            <div className="flex items-center gap-6 mb-10">
              ...
              <div>
                <h2 className="text-2xl font-extrabold">Mukul Kumar</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <InfoItem icon={User} label="Government ID" value="HR-1234567890" />
               <InfoItem icon={BadgeCheck} label="Job Role" value="Senior Field Engineer" />
               <InfoItem icon={Mail} label="Email Address" value="mukul.kumar@haryana.gov.in" />
               <InfoItem icon={Phone} label="Mobile Number" value="+91 98765 43210" />
            </div>
          </div>
