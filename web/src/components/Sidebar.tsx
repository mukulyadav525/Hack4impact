  ...
  return (
    <div className="flex h-screen w-64 flex-col bg-white border-r border-gray-100 dark:bg-black dark:border-zinc-900">
      ...
      <div className="p-4 border-t border-gray-100 dark:border-zinc-900">
        <button className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-red-500 hover:bg-red-50 transition-all dark:hover:bg-red-900/10">
          <LogOut size={20} />
          Sign Out
        </button>
      </div>
