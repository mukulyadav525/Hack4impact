        ...
        <div className="lg:col-span-2 space-y-6">
          <InfoCard title="Quick Actions">
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Link href="/lesson-plan" className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all text-center group">
                ...
                <Link href="/class-session" className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all text-center group">
                ...
                <Link href="/digital-register" className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all text-center group">
                ...
                <Link href="/ptm-log" className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all text-center group">
